namespace ClinicApp.Migrations
{
    ...
    public partial class CreateDatabaseClinic : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        FirstName = c.String(nullable: false, maxLength: 100),
                        LastName = c.String(nullable: false, maxLength: 100),
                        PatientCode = c.String(maxLength: 20),
            ...
            CreateTable(
                "dbo.InsuranceCalculations",
                c => new
                    {
                        InsuranceCalculationId = c.Int(nullable: false, identity: true),
                        PatientId = c.Int(nullable: false),
                        ServiceId = c.Int(nullable: false),
                        InsurancePlanId = c.Int(nullable: false),
                        PatientInsuranceId = c.Int(nullable: false),
                        ServiceAmount = c.Decimal(nullable: false, precision: 18, scale: 2),
                        InsuranceShare = c.Decimal(nullable: false, precision: 18, scale: 2),
                        PatientShare = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Copay = c.Decimal(precision: 18, scale: 2),
                        CoverageOverride = c.Decimal(precision: 18, scale: 2),
                        CoveragePercent = c.Decimal(nullable: false, precision: 5, scale: 2),
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_InsuranceCalculation_ActiveInsuranceCalculations", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_InsuranceCalculation_IsDeletedFilter", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.InsuranceCalculationId)
                .ForeignKey("dbo.Appointments", t => t.AppointmentId)
                .ForeignKey("dbo.AspNetUsers", t => t.CreatedByUserId)
                .ForeignKey("dbo.AspNetUsers", t => t.DeletedByUserId)
                .ForeignKey("dbo.InsurancePlans", t => t.InsurancePlanId)
                .ForeignKey("dbo.Patients", t => t.PatientId)
                .ForeignKey("dbo.PatientInsurances", t => t.PatientInsuranceId)
                .ForeignKey("dbo.Receptions", t => t.ReceptionId)
                .ForeignKey("dbo.Services", t => t.ServiceId)
                .ForeignKey("dbo.AspNetUsers", t => t.UpdatedByUserId)
                .Index(t => new { t.PatientId, t.CalculationDate }, name: "IX_InsuranceCalculation_PatientId_CalculationDate")
                .Index(t => new { t.ServiceId, t.CalculationDate }, name: "IX_InsuranceCalculation_ServiceId_CalculationDate")
                .Index(t => new { t.InsurancePlanId, t.CalculationDate }, name: "IX_InsuranceCalculation_InsurancePlanId_CalculationDate")
                .Index(t => t.PatientInsuranceId)
                .Index(t => t.ServiceAmount, name: "IX_InsuranceCalculation_ServiceAmount")
                .Index(t => t.InsuranceShare, name: "IX_InsuranceCalculation_InsuranceShare")
                .Index(t => t.PatientShare, name: "IX_InsuranceCalculation_PatientShare")
                .Index(t => t.Copay, name: "IX_InsuranceCalculation_Copay")
                .Index(t => t.CoverageOverride, name: "IX_InsuranceCalculation_CoverageOverride")
                .Index(t => t.CoveragePercent, name: "IX_InsuranceCalculation_CoveragePercent")
                .Index(t => t.Deductible, name: "IX_InsuranceCalculation_Deductible")
                .Index(t => t.CalculationDate, name: "IX_InsuranceCalculation_CalculationDate")
                .Index(t => t.CalculationType, name: "IX_InsuranceCalculation_CalculationType")
                .Index(t => new { t.CalculationType, t.IsValid }, name: "IX_InsuranceCalculation_CalculationType_IsValid")
                .Index(t => t.IsValid, name: "IX_InsuranceCalculation_IsValid")
                .Index(t => t.ReceptionId)
                .Index(t => t.AppointmentId)
                .Index(t => t.IsDeleted, name: "IX_InsuranceCalculation_IsDeleted")
                .Index(t => t.DeletedAt, name: "IX_InsuranceCalculation_DeletedAt")
                .Index(t => t.DeletedByUserId, name: "IX_InsuranceCalculation_DeletedByUserId")
                .Index(t => t.CreatedAt, name: "IX_InsuranceCalculation_CreatedAt")
                .Index(t => t.CreatedByUserId, name: "IX_InsuranceCalculation_CreatedByUserId")
                .Index(t => t.UpdatedAt, name: "IX_InsuranceCalculation_UpdatedAt")
                .Index(t => t.UpdatedByUserId, name: "IX_InsuranceCalculation_UpdatedByUserId");
            
            CreateTable(
                "dbo.InsurancePlans",
                c => new
                    {
                        InsurancePlanId = c.Int(nullable: false, identity: true),
                        InsuranceProviderId = c.Int(nullable: false),
                        PlanCode = c.String(nullable: false, maxLength: 100),
                        Name = c.String(nullable: false, maxLength: 250),
                        Description = c.String(maxLength: 500),
                        CoveragePercent = c.Decimal(nullable: false, precision: 5, scale: 2),
                        Deductible = c.Decimal(nullable: false, precision: 18, scale: 2),
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_InsurancePlan_ActiveInsurancePlans", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_InsurancePlan_IsDeletedFilter", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                ...
                .ForeignKey("dbo.AspNetUsers", t => t.UpdatedByUserId)
                .Index(t => new { t.InsuranceProviderId, t.IsActive, t.IsDeleted }, name: "IX_InsurancePlan_Provider_IsActive_IsDeleted")
                .Index(t => t.PlanCode, name: "IX_InsurancePlan_PlanCode")
                .Index(t => t.Name, name: "IX_InsurancePlan_Name")
                .Index(t => t.ValidFrom, name: "IX_InsurancePlan_ValidFrom")
                .Index(t => new { t.ValidFrom, t.ValidTo, t.IsActive }, name: "IX_InsurancePlan_Validity_IsActive")
                .Index(t => t.ValidTo, name: "IX_InsurancePlan_ValidTo")
                .Index(t => t.IsActive, name: "IX_InsurancePlan_IsActive")
                .Index(t => t.IsDeleted, name: "IX_InsurancePlan_IsDeleted")
                .Index(t => t.DeletedAt, name: "IX_InsurancePlan_DeletedAt")
                .Index(t => t.DeletedByUserId)
                .Index(t => t.CreatedAt, name: "IX_InsurancePlan_CreatedAt")
                .Index(t => t.CreatedByUserId)
                .Index(t => t.UpdatedAt, name: "IX_InsurancePlan_UpdatedAt")
            ...
            CreateTable(
                ...
                c => new
                    {
                        InsuranceProviderId = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false, maxLength: 250),
                        Code = c.String(nullable: false, maxLength: 50),
                        ContactInfo = c.String(maxLength: 1000),
                        IsActive = c.Boolean(nullable: false),
                        IsDeleted = c.Boolean(nullable: false),
                        DeletedAt = c.DateTime(),
                        DeletedByUserId = c.String(maxLength: 128),
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_InsuranceProvider_ActiveInsuranceProviders", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_InsuranceProvider_IsDeletedFilter", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.InsuranceProviderId)
                .ForeignKey("dbo.AspNetUsers", t => t.CreatedByUserId)
                .ForeignKey("dbo.AspNetUsers", t => t.DeletedByUserId)
                .ForeignKey("dbo.AspNetUsers", t => t.UpdatedByUserId)
                .Index(t => t.Name, name: "IX_InsuranceProvider_Name")
                .Index(t => t.Code, name: "IX_InsuranceProvider_Code")
                .Index(t => new { t.Code, t.IsActive }, name: "IX_InsuranceProvider_Code_IsActive")
                .Index(t => t.IsActive, name: "IX_InsuranceProvider_IsActive")
                .Index(t => new { t.IsActive, t.IsDeleted }, name: "IX_InsuranceProvider_IsActive_IsDeleted")
                .Index(t => t.IsDeleted, name: "IX_InsuranceProvider_IsDeleted")
                .Index(t => t.DeletedAt, name: "IX_InsuranceProvider_DeletedAt")
                .Index(t => t.DeletedByUserId)
                .Index(t => t.CreatedAt, name: "IX_InsuranceProvider_CreatedAt")
                .Index(t => t.CreatedByUserId)
                .Index(t => t.UpdatedAt, name: "IX_InsuranceProvider_UpdatedAt")
                .Index(t => t.UpdatedByUserId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        PatientInsuranceId = c.Int(nullable: false, identity: true),
                        PatientId = c.Int(nullable: false),
                        InsurancePlanId = c.Int(nullable: false),
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_PatientInsurance_ActivePatientInsurances", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_PatientInsurance_IsDeletedFilter", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.PatientInsuranceId)
                .ForeignKey("dbo.AspNetUsers", t => t.CreatedByUserId)
                .ForeignKey("dbo.AspNetUsers", t => t.DeletedByUserId)
                .ForeignKey("dbo.Patients", t => t.PatientId)
                .ForeignKey("dbo.AspNetUsers", t => t.UpdatedByUserId)
                .ForeignKey("dbo.InsurancePlans", t => t.InsurancePlanId)
                .Index(t => new { t.PatientId, t.IsActive, t.IsDeleted }, name: "IX_PatientInsurance_Patient_IsActive_IsDeleted")
                .Index(t => new { t.PatientId, t.Priority, t.IsActive }, name: "IX_PatientInsurance_Patient_Priority_IsActive")
                .Index(t => new { t.InsurancePlanId, t.IsActive, t.IsDeleted }, name: "IX_PatientInsurance_Plan_IsActive_IsDeleted")
                .Index(t => t.PolicyNumber, name: "IX_PatientInsurance_PolicyNumber")
                .Index(t => t.CardNumber, name: "IX_PatientInsurance_CardNumber")
                .Index(t => t.StartDate, name: "IX_PatientInsurance_StartDate")
                .Index(t => new { t.StartDate, t.EndDate, t.IsActive }, name: "IX_PatientInsurance_Validity_IsActive")
                .Index(t => t.EndDate, name: "IX_PatientInsurance_EndDate")
                .Index(t => t.IsPrimary, name: "IX_PatientInsurance_IsPrimary")
                .Index(t => t.IsActive, name: "IX_PatientInsurance_IsActive")
                .Index(t => t.IsDeleted, name: "IX_PatientInsurance_IsDeleted")
                .Index(t => t.DeletedAt, name: "IX_PatientInsurance_DeletedAt")
                .Index(t => t.DeletedByUserId)
                .Index(t => t.CreatedAt, name: "IX_PatientInsurance_CreatedAt")
                .Index(t => t.CreatedByUserId)
                .Index(t => t.UpdatedAt, name: "IX_PatientInsurance_UpdatedAt")
                .Index(t => t.UpdatedByUserId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        PlanServiceId = c.Int(nullable: false, identity: true),
                        InsurancePlanId = c.Int(nullable: false),
                        ServiceCategoryId = c.Int(nullable: false),
                        Copay = c.Decimal(precision: 5, scale: 2),
                        CoverageOverride = c.Decimal(precision: 5, scale: 2),
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_PlanService_ActivePlanServices", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_PlanService_IsDeletedFilter", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.PlanServiceId)
                .ForeignKey("dbo.AspNetUsers", t => t.CreatedByUserId)
                .ForeignKey("dbo.AspNetUsers", t => t.DeletedByUserId)
                .ForeignKey("dbo.ServiceCategories", t => t.ServiceCategoryId)
                .ForeignKey("dbo.AspNetUsers", t => t.UpdatedByUserId)
                .ForeignKey("dbo.InsurancePlans", t => t.InsurancePlanId)
                .Index(t => new { t.InsurancePlanId, t.ServiceCategoryId, t.IsDeleted }, unique: true, name: "IX_PlanService_Plan_Category_IsDeleted")
                .Index(t => new { t.InsurancePlanId, t.IsCovered, t.IsDeleted }, name: "IX_PlanService_Plan_IsCovered_IsDeleted")
                .Index(t => t.IsCovered, name: "IX_PlanService_IsCovered")
                .Index(t => t.IsDeleted, name: "IX_PlanService_IsDeleted")
                .Index(t => t.DeletedAt, name: "IX_PlanService_DeletedAt")
                .Index(t => t.DeletedByUserId)
                .Index(t => t.CreatedAt, name: "IX_PlanService_CreatedAt")
                .Index(t => t.CreatedByUserId)
                .Index(t => t.UpdatedAt, name: "IX_PlanService_UpdatedAt")
                .Index(t => t.UpdatedByUserId);
            ...
            CreateTable(
                ...
                .Index(t => t.IsDeleted, name: "IX_DoctorServiceCategory_IsDeleted")
                .Index(t => t.DeletedAt, name: "IX_DoctorServiceCategory_DeletedAt")
                .Index(t => t.DeletedByUserId, name: "IX_DoctorServiceCategory_DeletedByUserId");
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        UpdatedAt = c.DateTime(),
                        UpdatedByUserId = c.String(maxLength: 128),
                        ActivePatientInsuranceId = c.Int(),
                    },
                annotations: new Dictionary<string, object>
                {
                ...
                .ForeignKey("dbo.PatientInsurances", t => t.ActivePatientInsuranceId)
                .ForeignKey("dbo.AspNetUsers", t => t.CreatedByUserId)
                .ForeignKey("dbo.AspNetUsers", t => t.DeletedByUserId)
                .ForeignKey("dbo.AspNetUsers", t => t.UpdatedByUserId)
                .ForeignKey("dbo.Doctors", t => t.DoctorId)
                ...
                .Index(t => t.ActivePatientInsuranceId, name: "IX_Reception_ActivePatientInsuranceId");
            ...
            CreateTable(
                ...
                .Index(t => t.InsurancePlanId, name: "IX_InsuranceTariff_InsurancePlanId");
                ...
                c => new
                    {
                        ...
                        MinAdvanceBookingDays = c.Int(nullable: false),
                        MaxAdvanceBookingDays = c.Int(nullable: false),
                        AllowSameDayBooking = c.Boolean(nullable: false),
                        RequirePatientRegistration = c.Boolean(nullable: false),
                        ...
                        CancellationNoticeHours = c.Int(nullable: false),
                        AllowEmergencyBooking = c.Boolean(nullable: false),
                        AllowWalkInPatients = c.Boolean(nullable: false),
                        MaxWalkInPatientsPerDay = c.Int(nullable: false),
                        IsDeleted = c.Boolean(nullable: false),
                        DeletedAt = c.DateTime(),
                        DeletedByUserId = c.String(maxLength: 128),
                        CreatedAt = c.DateTime(nullable: false),
            ...
            CreateTable(
                ...
                .Index(t => t.AppointmentId)
                .Index(t => t.ActivePatientInsuranceId, name: "IX_AppointmentSlot_ActivePatientInsuranceId")
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.InsuranceCalculations", "UpdatedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.InsuranceCalculations", "ServiceId", "dbo.Services");
            DropForeignKey("dbo.InsuranceCalculations", "ReceptionId", "dbo.Receptions");
            DropForeignKey("dbo.InsuranceCalculations", "PatientInsuranceId", "dbo.PatientInsurances");
            DropForeignKey("dbo.InsuranceCalculations", "PatientId", "dbo.Patients");
            DropForeignKey("dbo.InsuranceCalculations", "InsurancePlanId", "dbo.InsurancePlans");
            DropForeignKey("dbo.InsurancePlans", "UpdatedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.PlanServices", "InsurancePlanId", "dbo.InsurancePlans");
            DropForeignKey("dbo.PlanServices", "UpdatedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.PlanServices", "ServiceCategoryId", "dbo.ServiceCategories");
            ...
            DropForeignKey("dbo.AppointmentSlots", "ActivePatientInsuranceId", "dbo.PatientInsurances");
            ...
            DropForeignKey("dbo.InsuranceTariffs", "InsurancePlanId", "dbo.InsurancePlans");
            ...
            DropForeignKey("dbo.Receptions", "ActivePatientInsuranceId", "dbo.PatientInsurances");
            ...
            DropForeignKey("dbo.PlanServices", "DeletedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.PlanServices", "CreatedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.PatientInsurances", "InsurancePlanId", "dbo.InsurancePlans");
            DropForeignKey("dbo.PatientInsurances", "UpdatedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.PatientInsurances", "PatientId", "dbo.Patients");
            DropForeignKey("dbo.PatientInsurances", "DeletedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.PatientInsurances", "CreatedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.InsurancePlans", "InsuranceProviderId", "dbo.InsuranceProviders");
            DropForeignKey("dbo.InsuranceProviders", "UpdatedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.InsuranceProviders", "DeletedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.InsuranceProviders", "CreatedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.InsurancePlans", "DeletedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.InsurancePlans", "CreatedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.InsuranceCalculations", "DeletedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.InsuranceCalculations", "CreatedByUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.InsuranceCalculations", "AppointmentId", "dbo.Appointments");
            ...
            DropIndex("dbo.AppointmentSlots", "IX_AppointmentSlot_ActivePatientInsuranceId");
            ...
            DropIndex("dbo.InsuranceTariffs", "IX_InsuranceTariff_InsurancePlanId");
            ...
            DropIndex("dbo.Receptions", "IX_Reception_ActivePatientInsuranceId");
            ...
            DropIndex("dbo.PlanServices", new[] { "UpdatedByUserId" });
            DropIndex("dbo.PlanServices", "IX_PlanService_UpdatedAt");
            DropIndex("dbo.PlanServices", new[] { "CreatedByUserId" });
            DropIndex("dbo.PlanServices", "IX_PlanService_CreatedAt");
            DropIndex("dbo.PlanServices", new[] { "DeletedByUserId" });
            DropIndex("dbo.PlanServices", "IX_PlanService_DeletedAt");
            DropIndex("dbo.PlanServices", "IX_PlanService_IsDeleted");
            DropIndex("dbo.PlanServices", "IX_PlanService_IsCovered");
            DropIndex("dbo.PlanServices", "IX_PlanService_Plan_IsCovered_IsDeleted");
            DropIndex("dbo.PlanServices", "IX_PlanService_Plan_Category_IsDeleted");
            DropIndex("dbo.PatientInsurances", new[] { "UpdatedByUserId" });
            DropIndex("dbo.PatientInsurances", "IX_PatientInsurance_UpdatedAt");
            DropIndex("dbo.PatientInsurances", new[] { "CreatedByUserId" });
            DropIndex("dbo.PatientInsurances", "IX_PatientInsurance_CreatedAt");
            DropIndex("dbo.PatientInsurances", new[] { "DeletedByUserId" });
            DropIndex("dbo.PatientInsurances", "IX_PatientInsurance_DeletedAt");
            DropIndex("dbo.PatientInsurances", "IX_PatientInsurance_IsDeleted");
            DropIndex("dbo.PatientInsurances", "IX_PatientInsurance_IsActive");
            DropIndex("dbo.PatientInsurances", "IX_PatientInsurance_IsPrimary");
            DropIndex("dbo.PatientInsurances", "IX_PatientInsurance_EndDate");
            DropIndex("dbo.PatientInsurances", "IX_PatientInsurance_Validity_IsActive");
            DropIndex("dbo.PatientInsurances", "IX_PatientInsurance_StartDate");
            DropIndex("dbo.PatientInsurances", "IX_PatientInsurance_CardNumber");
            DropIndex("dbo.PatientInsurances", "IX_PatientInsurance_PolicyNumber");
            DropIndex("dbo.PatientInsurances", "IX_PatientInsurance_Plan_IsActive_IsDeleted");
            DropIndex("dbo.PatientInsurances", "IX_PatientInsurance_Patient_Priority_IsActive");
            DropIndex("dbo.PatientInsurances", "IX_PatientInsurance_Patient_IsActive_IsDeleted");
            DropIndex("dbo.InsuranceProviders", new[] { "UpdatedByUserId" });
            DropIndex("dbo.InsuranceProviders", "IX_InsuranceProvider_UpdatedAt");
            DropIndex("dbo.InsuranceProviders", new[] { "CreatedByUserId" });
            DropIndex("dbo.InsuranceProviders", "IX_InsuranceProvider_CreatedAt");
            DropIndex("dbo.InsuranceProviders", new[] { "DeletedByUserId" });
            DropIndex("dbo.InsuranceProviders", "IX_InsuranceProvider_DeletedAt");
            DropIndex("dbo.InsuranceProviders", "IX_InsuranceProvider_IsDeleted");
            DropIndex("dbo.InsuranceProviders", "IX_InsuranceProvider_IsActive_IsDeleted");
            DropIndex("dbo.InsuranceProviders", "IX_InsuranceProvider_IsActive");
            DropIndex("dbo.InsuranceProviders", "IX_InsuranceProvider_Code_IsActive");
            DropIndex("dbo.InsuranceProviders", "IX_InsuranceProvider_Code");
            DropIndex("dbo.InsuranceProviders", "IX_InsuranceProvider_Name");
            DropIndex("dbo.InsurancePlans", new[] { "UpdatedByUserId" });
            DropIndex("dbo.InsurancePlans", "IX_InsurancePlan_UpdatedAt");
            DropIndex("dbo.InsurancePlans", new[] { "CreatedByUserId" });
            DropIndex("dbo.InsurancePlans", "IX_InsurancePlan_CreatedAt");
            DropIndex("dbo.InsurancePlans", new[] { "DeletedByUserId" });
            DropIndex("dbo.InsurancePlans", "IX_InsurancePlan_DeletedAt");
            DropIndex("dbo.InsurancePlans", "IX_InsurancePlan_IsDeleted");
            DropIndex("dbo.InsurancePlans", "IX_InsurancePlan_IsActive");
            DropIndex("dbo.InsurancePlans", "IX_InsurancePlan_ValidTo");
            DropIndex("dbo.InsurancePlans", "IX_InsurancePlan_Validity_IsActive");
            DropIndex("dbo.InsurancePlans", "IX_InsurancePlan_ValidFrom");
            DropIndex("dbo.InsurancePlans", "IX_InsurancePlan_Name");
            DropIndex("dbo.InsurancePlans", "IX_InsurancePlan_PlanCode");
            DropIndex("dbo.InsurancePlans", "IX_InsurancePlan_Provider_IsActive_IsDeleted");
            DropIndex("dbo.InsuranceCalculations", "IX_InsuranceCalculation_UpdatedByUserId");
            DropIndex("dbo.InsuranceCalculations", "IX_InsuranceCalculation_UpdatedAt");
            DropIndex("dbo.InsuranceCalculations", "IX_InsuranceCalculation_CreatedByUserId");
            DropIndex("dbo.InsuranceCalculations", "IX_InsuranceCalculation_CreatedAt");
            DropIndex("dbo.InsuranceCalculations", "IX_InsuranceCalculation_DeletedByUserId");
            DropIndex("dbo.InsuranceCalculations", "IX_InsuranceCalculation_DeletedAt");
            DropIndex("dbo.InsuranceCalculations", "IX_InsuranceCalculation_IsDeleted");
            DropIndex("dbo.InsuranceCalculations", new[] { "AppointmentId" });
            DropIndex("dbo.InsuranceCalculations", new[] { "ReceptionId" });
            DropIndex("dbo.InsuranceCalculations", "IX_InsuranceCalculation_IsValid");
            ...
            DropIndex("dbo.InsuranceCalculations", "IX_InsuranceCalculation_CalculationDate");
            DropIndex("dbo.InsuranceCalculations", "IX_InsuranceCalculation_Deductible");
            DropIndex("dbo.InsuranceCalculations", "IX_InsuranceCalculation_CoveragePercent");
            ...
            DropIndex("dbo.InsuranceCalculations", new[] { "PatientInsuranceId" });
            DropIndex("dbo.InsuranceCalculations", "IX_InsuranceCalculation_InsurancePlanId_CalculationDate");
            DropIndex("dbo.InsuranceCalculations", "IX_InsuranceCalculation_ServiceId_CalculationDate");
            DropIndex("dbo.InsuranceCalculations", "IX_InsuranceCalculation_PatientId_CalculationDate");
            ...
            DropTable("dbo.InsuranceCalculations",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_InsuranceCalculation_ActiveInsuranceCalculations", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_InsuranceCalculation_IsDeletedFilter", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
