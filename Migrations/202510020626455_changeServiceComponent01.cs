namespace ClinicApp.Migrations
{
    ...
    public partial class changeServiceComponent01 : DbMigration
    {
        ...
        {
            DropIndex("dbo.ServiceComponents", "IX_ServiceComponent_Coefficient");
            AlterColumn("dbo.ServiceComponents", "Coefficient", c => c.Decimal(nullable: false, precision: 18, scale: 2));
            CreateIndex("dbo.ServiceComponents", "Coefficient", name: "IX_ServiceComponent_Coefficient");
        }
    }
}
