...
{
    /// <summary>
    /// ViewModel تخصصی برای نمایش محاسبه realtime در فرم پذیرش
    /// </summary>
    public class ReceptionRealtimeCalculationViewModel
    {
        /// <summary>
        /// شناسه بیمار
        /// </summary>
        ...
        /// <summary>
        /// نمایش اطلاعات محاسبه realtime (فرمات شده)
        /// </summary>
        public string RealtimeCalculationInfoDisplay
        {
            get
            {
        ...
        /// </summary>
        public string RealtimeStatus => IsRealtime ? "محاسبه realtime" : "محاسبه عادی";
    }
}