...
namespace ClinicApp.ViewModels.Reception
{
    ...
    public class ReceptionComponentViewModels
    {
        ...
        #region Reception Edit ViewModel

        /// <summary>
        /// ViewModel برای ویرایش پذیرش
        /// </summary>
        ...
        #region Reception Search ViewModel

        /// <summary>
        /// ViewModel برای جستجوی پذیرش‌ها
        /// </summary>
        public class ReceptionSearchViewModel
        {
            ...
            /// </summary>
            [Display(Name = "نام پزشک")]
            [StringLength(100, ErrorMessage = "نام پزشک نمی‌تواند بیش از 100 کاراکتر باشد")]
            public string DoctorName { get; set; }
        ...
        #region Reception Details ViewModel

        /// <summary>
        /// ViewModel برای جزئیات پذیرش
        /// </summary>
        ...
        #region Reception Index ViewModel
        ...
        {
            /// <summary>
            /// لیست پذیرش‌های امروز
            /// </summary>
            public List<ReceptionHistoryItemViewModel> TodayReceptions { get; set; } = new List<ReceptionHistoryItemViewModel>();

            /// <summary>
            /// آمار پذیرش‌ها
            /// </summary>
            public ReceptionStatisticsViewModel Statistics { get; set; } = new ReceptionStatisticsViewModel();

            /// <summary>
            /// فیلترهای جستجو
            /// </summary>
            public ReceptionSearchViewModel SearchFilters { get; set; } = new ReceptionSearchViewModel();

            /// <summary>
            /// وضعیت سیستم
            /// </summary>
            public string SystemStatus { get; set; } = "فعال";
