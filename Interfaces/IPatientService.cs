...
namespace ClinicApp.Interfaces
{
    ...
    public interface IPatientService
    {
        ...
        /// 
        /// ویژگی‌های کلیدی:
        /// 1. بررسی سریع وجود کد ملی در سیستم
        /// 2. پشتیبانی از سیستم حذف نرم (Soft Delete)
        /// 3. لاگ‌گیری حرفه‌ای برای امنیت
        /// 4. عملکرد بهینه برای استفاده در اعتبارسنجی JavaScript
        /// 
        /// استانداردهای پزشکی رعایت شده:
        /// - رعایت استانداردهای قانونی ایران در نگهداری اطلاعات پزشکی
        /// - جلوگیری از تکرار کد ملی در سیستم
        /// - ردیابی کامل عملیات‌ها برای حسابرسی
        /// 
        /// امنیت:
        ...
        /// </summary>
        /// <param name="nationalCode">کد ملی مورد نظر برای بررسی</param>
        /// <returns>نتیجه بررسی وجود کد ملی</returns>
        ...
        /// 
        /// ویژگی‌های کلیدی:
        /// 1. دریافت بیمه‌های فعال و غیرحذف شده بیمار
        /// 2. مرتب‌سازی بر اساس اولویت (Primary/Secondary)
        /// 3. شامل اطلاعات کامل InsurancePlan و InsuranceProvider
        /// 4. پشتیبانی از تاریخ شمسی
        /// 5. لاگ‌گیری حرفه‌ای برای امنیت
        /// 
        /// استانداردهای پزشکی رعایت شده:
        /// - رعایت استانداردهای قانونی ایران در نگهداری اطلاعات بیمه
        /// - نمایش اطلاعات کامل بیمه‌های فعال
        /// - ردیابی کامل عملیات‌ها برای حسابرسی
        /// 
        /// امنیت:
        /// - بررسی دسترسی کاربر به اطلاعات بیمه
        /// - لاگ‌گیری دقیق برای هر درخواست
        /// - جلوگیری از نشت اطلاعات حساس بیمه‌ای
        /// </summary>
        ...
        Task<ServiceResult<List<PatientInsuranceViewModel>>> GetPatientInsurancesAsync(int patientId, int pageNumber = 1, int pageSize = 10);

        /// <summary>
        /// دریافت تاریخچه نوبت‌های بیمار
        /// 
        /// ویژگی‌های کلیدی:
        /// 1. دریافت تمام نوبت‌های بیمار (غیرحذف شده)
        /// 2. مرتب‌سازی بر اساس تاریخ نوبت (جدیدترین اول)
        /// 3. شامل اطلاعات کامل پزشک و دسته‌بندی خدمت
        /// 4. پشتیبانی از تاریخ شمسی
        /// 5. تبدیل وضعیت نوبت به متن فارسی
        /// 6. لاگ‌گیری حرفه‌ای برای امنیت
        /// 
        /// استانداردهای پزشکی رعایت شده:
        /// - رعایت استانداردهای قانونی ایران در نگهداری اطلاعات پزشکی
        /// - نمایش تاریخچه کامل نوبت‌های بیمار
        /// - ردیابی کامل عملیات‌ها برای حسابرسی
        /// 
        /// امنیت:
        /// - بررسی دسترسی کاربر به اطلاعات نوبت‌ها
        /// - لاگ‌گیری دقیق برای هر درخواست
        ...
        /// 
        /// ویژگی‌های کلیدی:
        /// 1. دریافت تمام پذیرش‌های بیمار (غیرحذف شده)
        /// 2. مرتب‌سازی بر اساس تاریخ پذیرش (جدیدترین اول)
        /// 3. شامل اطلاعات کامل پزشک، خدمات و پرداخت‌ها
        /// 4. محاسبه وضعیت پرداخت و تعداد خدمات
        /// 5. پشتیبانی از تاریخ شمسی
        /// 6. تبدیل وضعیت پذیرش به متن فارسی
        /// 7. لاگ‌گیری حرفه‌ای برای امنیت
        /// 
        /// استانداردهای پزشکی رعایت شده:
        /// - رعایت استانداردهای قانونی ایران در نگهداری اطلاعات پزشکی
        /// - نمایش تاریخچه کامل پذیرش‌های بیمار
        /// - ردیابی کامل عملیات‌ها برای حسابرسی
        /// 
        /// امنیت:
        /// - بررسی دسترسی کاربر به اطلاعات پذیرش‌ها
        /// - لاگ‌گیری دقیق برای هر درخواست
        /// - جلوگیری از نشت اطلاعات حساس پزشکی
        /// </summary>
        /// <param name="patientId">شناسه بیمار مورد نظر</param>
