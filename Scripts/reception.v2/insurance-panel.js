    ...
    return repricePromise
      .then(function(fullResponse) {
        ...
        if (changes.length > 0) {
          ...
          // اگر تغییری نبود، فقط پیغام ساده + تأیید به‌روز بودن قیمت‌ها
          toastr.success('بیمه‌ها ذخیره شدند. قیمت‌ها به‌روز است.', 'ثبت/بازمحاسبه', {
            timeOut: 4000,
            closeButton: true
          });
        }
